...
//   let elms = document.querySelectorAll('.slider_mob')
...
document.addEventListener('DOMContentLoaded', function () {
  $slider1 = new ChiefSlider('.portfolioSliderMobOne', { loop: false })
  $slider2 = new ChiefSlider('.portfolioSliderMobTwo', { loop: false })
  $slider3 = new ChiefSlider('.portfolioSliderMobThree', { loop: false })
  $slider4 = new ChiefSlider('.portfolioSliderMobFour', { loop: false })
  $slider5 = new ChiefSlider('.portfolioSliderMobFive', { loop: false })
  $slider6 = new ChiefSlider('.portfolioSliderMobSix', { loop: false })
  $slider7 = new ChiefSlider('.portfolioSliderMobSeven', { loop: false })
})
